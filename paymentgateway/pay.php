	...
	<form  method="post" action="post.php" name="frmTransaction" id="frmTransaction" >
     <table width="600" cellpadding="2" cellspacing="2" border="0">
	   ...
	   <tr>
            ...
            <td  align="left" width="50%"> <input name="account_id" type="text" value="18195"/><br><span><font color="red"> Please Enter your Account ID provided.</font></span> </td>
        </tr>
        <tr>
            <td class="fieldName" width="50%"><span class="error">*</span> Secret Key</td>
            <td  align="left" width="50%"> <input name="secretkey" type="text" value="8867f47644aded51aac79afbf24dfc92" size="35"/><br><span><font color="red"> Please Enter your Secret Key provided.</font></span></td>
        </tr>
	   <tr>
        ...
        <tr>
            <td class="fieldName">payment_mode</td>
            <td align="left"><input name="payment_mode" type="text" value="1" /></td>
        </tr>
